...
<body>
        ...
        <div class="mu-slider-area">
            ...
            <div class="mu-top-slider">
                ...
                <div class="mu-top-slider-single">
                    <img src="/static/image/slide1.jpg" alt="img">
                    <!-- Top slider content -->
                ...
                <!-- Top slider single slide -->
                <div class="mu-top-slider-single">
                    <img src="/static/image/slide2.jpg" alt="img">
                    <!-- Top slider content -->
                    <div class="mu-top-slider-content">
                ...
                <!-- Top slider single slide -->
                <div class="mu-top-slider-single">
                    <img src="/static/image/slide3.jpg" alt="img">
                    <!-- Top slider content -->
                    <div class="mu-top-slider-content">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mu-about-us-left">
                                    <img src="/static/image/aboutUs.jpg" alt="img">
                                </div>
                            </div>
                            <div class="col-md-6">
                                                        ...
                                                        <li>
                                                            <div class="media">
                                                                <div class="media-left">
                                                                    <a href="#">
                                                                        <img class="media-object" width="45" height="45" src="/img/${l.filename}">
                                                                    </a>
                                                                </div>
                                                                <div class="media-body">
                                                                    <h4 class="media-heading">${l.name_food}<a href="#"></a></h4>
                                                                    <span class="mu-menu-price">${l.cost_food}$</span>
                                                                    <p>${l.describe_food}</p>
                                                                </div>
                                                            </div>
                                                        </li>
                                                    ...
                                                    <ul class="mu-menu-item-nav">
                                                        ...
                                                        <li>
                                                            <div class="media">
                                                                <div class="media-left">
                                                                    <a href="#">
                                                                        <img class="media-object" src="/img/${rig.filename}" alt="img">
                                                                    </a>
                                                                </div>
                                                                <div class="media-body">
                                                                    <h4 class="media-heading"><a href="#">${rig.name_food}</a></h4>
                                                                    <span class="mu-menu-price">$${rig.cost_food}</span>
                                                                    <p>${rig.describe_food}</p>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        </#list>
                                                    ...
                                                    <ul class="mu-menu-item-nav">
                                                        <li>
                                                            <div class="media">
                                                                <div class="media-left">
                                                                    <a href="#">
                                                                        <img class="media-object" src="/static/image/Galery1.jpg" alt="img">
                                                                    </a>
                                                                </div>
                                                                <div class="media-body">
                                                    ...
                                                    <ul class="mu-menu-item-nav">
                                                        ...
                                                        <li>
                                                            <div class="media">
                                                                <div class="media-left">
                                                                    <a href="#">
                                                                        <img class="media-object"   alt="img">
                                                                    </a>
                                                                </div>
                                                                <div class="media-body">
                                                                    <h4 class="media-heading"><a href="#">Indian Breakfast</a></h4>
                        ...
                        <div class="mu-gallery-content">
                            ...
                            <div class="mu-gallery-body">
                                ...
                                <div class="mu-single-gallery col-md-4">
                                    <div class="mu-single-gallery-item">
                                        <figure class="mu-single-gallery-img">
                                            <a class="mu-imglink" href="/static/image/Galery1.jpg">
                                                <img alt="img" src="/static/image/Galery1.jpg">
                                                <div class="mu-single-gallery-info">
                                                    <img class="mu-view-btn" src="/static/image/plus.png" alt="plus icon img">
                                                </div>
                                            </a>
                                        </figure>
                                    </div>
                                ...
                                <div class="mu-single-gallery col-md-4">
                                    <div class="mu-single-gallery-item">
                                        <figure class="mu-single-gallery-img">
                                            <a class="mu-imglink" href="/static/image/Galery2.jpg">
                                                <img alt="img" src="/static/image/Galery2.jpg">
                                                <div class="mu-single-gallery-info">
                                                    <img class="mu-view-btn" src="/static/image/plus.png" alt="plus icon img">
                                                </div>
                                            </a>
                                ...
                                <div class="mu-single-gallery col-md-4">
                                    <div class="mu-single-gallery-item">
                                        <figure class="mu-single-gallery-img">
                                            <a class="mu-imglink" href="/static/image/Galery3.jpg">
                                                <img alt="img" src="/static/image/Galery3.jpg">
                                                <div class="mu-single-gallery-info">
                                                    <img class="mu-view-btn" src="/static/image/plus.png" alt="plus icon img">
                                                </div>
                                            </a>
                                ...
                                <div class="mu-single-gallery col-md-4">
                                    <div class="mu-single-gallery-item">
                                        <figure class="mu-single-gallery-img">
                                            <a class="mu-imglink" href="/static/image/Galery4.jpg">
                                                <img alt="img" src="/static/image/Galery4.jpg">
                                                <div class="mu-single-gallery-info">
                                                    <img class="mu-view-btn" src="/static/image/plus.png" alt="plus icon img">
                                                </div>
                                            </a>
                                ...
                                <div class="mu-single-gallery col-md-4">
                                    <div class="mu-single-gallery-item">
                                        <figure class="mu-single-gallery-img">
                                            <a class="mu-imglink" href="/static/image/Galery5.jpg">
                                                <img alt="img" src="/static/image/Galery5.jpg">
                                                <div class="mu-single-gallery-info">
                                                    <img class="mu-view-btn" src="/static/image/plus.png" alt="plus icon img">
                                                </div>
                                            </a>
                                ...
                                <div class="mu-single-gallery col-md-4">
                                    <div class="mu-single-gallery-item">
                                        <figure class="mu-single-gallery-img">
                                            <a class="mu-imglink" href="/static/image/Galery6.jpg">
                                                <img alt="img" src="/static/image/Galery6.jpg">
                                                <div class="mu-single-gallery-info">
                                                    <img class="mu-view-btn" src="/static/image/plus.png" alt="plus icon img">
                                                </div>
                                            </a>
                                ...
                                <div class="mu-single-gallery col-md-4">
                                    <div class="mu-single-gallery-item">
                                        <figure class="mu-single-gallery-img">
                                            <a class="mu-imglink" href="/static/image/Galery7.jpg">
                                                <img alt="img" src="/static/image/Galery7.jpg">
                                                <div class="mu-single-gallery-info">
                                                    <img class="mu-view-btn" src="/static/image/plus.png" alt="plus icon img">
                                                </div>
                                            </a>
                                ...
                                <div class="mu-single-gallery col-md-4">
                                    <div class="mu-single-gallery-item">
                                        <figure class="mu-single-gallery-img">
                                            <a class="mu-imglink" href="/static/image/Galery8.jpg">
                                                <img alt="img" src="/static/image/Galery8.jpg">
                                                <div class="mu-single-gallery-info">
                                                    <img class="mu-view-btn" src="/static/image/plus.png" alt="plus icon img">
                                                </div>
                                            </a>
                                ...
                                <div class="mu-single-gallery col-md-4">
                                    <div class="mu-single-gallery-item">
                                        <figure class="mu-single-gallery-img">
                                            <a class="mu-imglink" href="/static/image/Galery9.jpg">
                                                <img alt="img" src="/static/image/Galery9.jpg">
                                                <div class="mu-single-gallery-info">
                                                    <img class="mu-view-btn" src="/static/image/plus.png" alt="plus icon img">
                                                </div>
                                            </a>
    ...
    <!-- Counter -->
    <script type="text/javascript" src="/static/js/simple-animated-counter.js"></script>
    <!-- Gallery Lightbox -->
